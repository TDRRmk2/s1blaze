...
loc_E0:
		...
		dc.b "BLAZE THE CAT IN SONIC THE HEDGEHOG 1 REDUX     " ; Domestic name
		dc.b "BLAZE THE CAT IN SONIC THE HEDGEHOG 1 REDUX     " ; International name
		if Revision=0
...
; Do not add anything else after this include.
